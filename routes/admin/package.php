...
Route::group(['middleware' => 'auth:user'], function(){
    Route::get('/packages', [CategoryPackageController::class, 'index'])->name('packages');
    Route::get('/package/all',  [CategoryPackageController::class, 'allPackage'])->name('package.all');
